...
export function TutorClassDetail({ 
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        if (studentsResponse.data?.students) {
          ...
          setStudents(fetchedStudents.length > 0 ? fetchedStudents : defaultStudents);
        }
      } catch (err) {
  ...
  // Default mock students (fallback if no enrolled students)
  const defaultStudents: Student[] = [
    {
      ...
      isOnline: true,
      grade: 85,
      feedback: 'Good progress in calculus',
